...
Por ejemplo, si el backend eta caido o hay un error en el formato de la orden, el sistema captura la excepción y la envía automáticamente a **Sentry**, junto con el **contexto de la solicitud** y los **datos enviados**.
...
[Link del video](http://localhost:3000)
