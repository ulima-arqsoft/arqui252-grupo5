...
Antes de seguir, primero se debe configurar strapi, una vez abierto, pedira que se loguee con una cuenta de admin nueva (Se puede rellenar con cualquier dato)
...
Una vez realizado esto, en la terminal se debe colocar:
```bash
docker-compose up
```
y luego
