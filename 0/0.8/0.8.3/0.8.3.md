...
En Strapi se configuró un backend funcional un **Content Types**:

- **Articles:** título, contenido, imagen, categoría y fecha.  

### Configuraciones realizadas:
- creacion del content type
- añadir campos al content-type
- posibilidad de llamar a traves de comandos REST
...
[Link del video](https://youtu.be/3mFRSD7j8Ug)
